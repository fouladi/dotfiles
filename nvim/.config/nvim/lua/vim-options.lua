...
opt.shortmess = "aTI"   -- No -welcome- message
...
vim.api.nvim_command("command! Encrypt lua EncryptBuffer()")
vim.api.nvim_command("command! Decrypt lua DecryptBuffer()")
-- Optional: Map keys to the commands
