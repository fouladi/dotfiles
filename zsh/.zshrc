...
plugins=(colored-man-pages git zsh-autosuggestions virtualenv pyenv colorize extract z)
...
# # 3/3. powerlevel10k: To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
